  ...
  return (
    ...
    >
      <div className="relative h-44 overflow-hidden border-b border-line sm:h-56">
        <AsciiBanner src="/ascii-animation.mp4" alt="Profile Banner" />
      </div>
      ...
      <div className="relative px-5 pb-5 sm:px-6 sm:pb-6">
        ...
        <div className="mt-3 min-w-0">
          <div className="flex flex-wrap items-center gap-2 sm:gap-2.5">
            <h1 className="text-[18px] md:text-[20px] font-bold leading-6 tracking-tight text-foreground sm:text-[22px]">
              {USER.displayName}
            </h1>
        ...
        <p className="mt-3.5 max-w-2xl text-[12px] md:text-[15px] leading-relaxed text-foreground sm:text-base">
          {l(USER.about, USER.aboutId)}
        </p>

        <div className="mt-4 flex flex-wrap gap-x-4 gap-y-2 text-[10px] md:text-sm text-muted-foreground">
